...
const links = [
  { href: `mailto:${profile.email}`, label: 'Email', Icon: Mail, hoverClass: 'hover:bg-primary hover:text-bg hover:border-primary' },
  { href: profile.linkedin, label: 'LinkedIn', Icon: Linkedin, hoverClass: 'hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2]' },
  { href: profile.github, label: 'GitHub', Icon: Github, hoverClass: 'hover:bg-fg hover:text-bg hover:border-fg' },
];
